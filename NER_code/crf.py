"""
Code obtained from the repo: https://github.com/kmkurn/pytorch-crf
All credits to the repo owner: Kemal Kurniawan (kmkurn)
Minimal changes done to return sentence probability on the viterbi decode function
"""
